...
// Indica que la conexion con la base de datos está perdida console.error('DATABASE CONNECTION WAS CLOSED');
break;
// Indica que existen demasiadas conexiones
case CONSTANTS.ER_CON_COUNT_ERROR:
console.error('DATABASE HAS TO MANY CONNECTIONS');
break;
// Indica que la conexion fue rechazada case CONSTANTS.ECONNREFUSED:
